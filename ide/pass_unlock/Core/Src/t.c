...
//	HAL_Delay(3000);
//	lcd_gotoxy(&lcd, 1, 0);
//	lcd_puts(&lcd, "INSIADE LOOP"); // Print message
//	HAL_Delay(1000);
//
...
//	{
//	    /* 1 */
//	    lcd_puts(&lcd,"You Pressed Key 1");
...
//	{
//	    /* 2 */
//	    lcd_puts(&lcd, "You Pressed Key 2");
...
//	{
//	    /* 3 */
//	    lcd_puts(&lcd, "You Pressed Key 3");
...
//	{
//	    /* A */
//	    lcd_send_cmd(&lcd, 0x0E);               // Move the cursor to second line
//	    lcd_puts(&lcd, "You Pressed Key A");
...
//	{
//	    /* 4 */
//	    lcd_send_cmd(&lcd, 0xC0);               // Move the cursor to second line
//	    lcd_puts(&lcd, "You Pressed Key 4");
//	    while (HAL_GPIO_ReadPin(GPIOA, C1_Pin));
//	}
//
//	if(HAL_GPIO_ReadPin(GPIOA, C2_Pin) == GPIO_PIN_SET)
//	{
//	    /* 5 */
//	    lcd_puts(&lcd, "You Pressed Key 5");
//	    while (HAL_GPIO_ReadPin(GPIOA, C2_Pin));
//	}
//
//	if(HAL_GPIO_ReadPin(GPIOA, C3_Pin) == GPIO_PIN_SET)
...
//
//	    lcd_send_cmd(&lcd, 0xC0);               // Move the cursor to second line
//	    lcd_puts(&lcd, "You Pressed Key 6");
//	    while (HAL_GPIO_ReadPin(GPIOA, C3_Pin));
//	}
//
//	if(HAL_GPIO_ReadPin(GPIOA, C4_Pin) == GPIO_PIN_SET)
//	{
//	    /* B */
//	    lcd_puts(&lcd, "You Pressed Key B");
//	    while (HAL_GPIO_ReadPin(GPIOA, C4_Pin));
//	}
//
...
//	{
//	    /* 7 */
//	    lcd_puts(&lcd, "You Pressed Key 7");
//	    while (HAL_GPIO_ReadPin(GPIOA, C1_Pin));
//	}
//
//	if(HAL_GPIO_ReadPin(GPIOA, C2_Pin) == GPIO_PIN_SET)
//	{
//	    /* 8 */
//	    lcd_puts(&lcd, "You Pressed Key 8");
//	    while (HAL_GPIO_ReadPin(GPIOA, C2_Pin));
//	}
//
//	if(HAL_GPIO_ReadPin(GPIOA, C3_Pin) == GPIO_PIN_SET)
...
//	    /* 9 */
//	    lcd_send_cmd(&lcd, 0x0E);               // Move the cursor to second line
//	    lcd_puts(&lcd, "You Pressed Key 9");
//	    while (HAL_GPIO_ReadPin(GPIOA, C3_Pin));
//	}
//
//	if(HAL_GPIO_ReadPin(GPIOA, C4_Pin) == GPIO_PIN_SET)
...
//	{
//	    /* 0 */
//	    lcd_puts(&lcd, "You Pressed Key 0");
//	    while (HAL_GPIO_ReadPin(GPIOA, C2_Pin));
//	}
//
//	if(HAL_GPIO_ReadPin(GPIOA, C3_Pin) == GPIO_PIN_SET)
...
//	{
//	    /* D */
//	    lcd_puts(&lcd, "You Pressed Key D");
//	    while (HAL_GPIO_ReadPin(GPIOA, C4_Pin));
//	}
//
//}
...
//	  HAL_Delay(3000);
//	  lcd_gotoxy(&lcd, 0, 1);
//	  lcd_send_cmd(&lcd, 0x0E);
//	  HAL_Delay(3000);
//	  if (keyPressed != 0) {
//		  lcd_putchar(&lcd, keyPressed);  // Print the pressed key on LCD
//		          enteredPassword[passwordIndex++] = keyPressed;  // Save key
//		          enteredPassword[passwordIndex] = '\0';          // Null-terminate
//
//		          lcd_gotoxy(&lcd, 1, 0);
//		          lcd_putchar(&lcd, keyPressed);
//
//		          keyPressed = 0;  // Reset keyPressed after processing
//
